...
int main()
{
	char name[30], pizza1[]="Pizza Margherita" ,pizza2[]="Chicken BBQ" ,pizza3[]="Peri Peri" ,pizza4[]="Cheese Burst", roll1[]="Chicken Roll", roll2[]="Mayo Roll", roll3[]="Paneer Roll",bur1[]="Zinger Burger",bur2[]="Chicken Burger",bur3[]="Veg Burger";
	char sand1[]="Club Sandwich", sand2[]="Crispy Sandwich", sand3[]="Extream Veg Loaded";
	char bir1[]="Chicken Biryani", bir2[]="Mutton Biryani", bir3[]="Aloo Dam Biryani",gotostart ;
	int choice=0,pchoice,pchoice1, quantity;
	beginning:
	system("CLS");
	cout<<"\t\t\t-:Welcome to 'THE YUMMY FOODS ':-\n\n";
	...
	if(choice==1)
	 {
		...
		if(pchoice>=1 && pchoice<=4)
		{
			...
			switch (pchoice1)
			{
			 ...
			 cout<<"\n\nThank you For Ordering From 'THE YUMMY FOODS '\n";
			 break;
			 case 2:
			 cout<<"\t\t--------Your Order---------\n";
